            ...
            <form wire:submit.prevent="updatePost">
                <div class="form-group row mt-3">
                    <div class="col-12 col-md-6">
                        ...
                        <select class="form-select" name="category" wire:model="category" required>
                ...
                <div wire:ignore class="form-group mt-3">
                    ...
                    <textarea wire:model.lazy="content" name="content" id="content" class="form-control">{!! $content !!}</textarea>
