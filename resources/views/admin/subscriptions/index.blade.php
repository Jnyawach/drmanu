                ...
                <div class="col-12 mx-auto">
                    <div class="card shadow-sm">
                        <div class="card-header p-3">
                            <h5 style="font-size: 18px" class="float-start">Subscribers</h5>
                            <!-- Button trigger modal -->
                            <button class="float-end btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#subscriberModal">Add Subscriber
                            </button>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('subscriptions.store')}}" method="POST" id="roleForm">
                                                @csrf
                                                @honeypot
                                                ...
                                                <div class="form-group required">
                                                    <label class="control-label" for="email">
                                                        Email:</label>
                                                    <input type="email" class="form-control complete" name="email"
                                                           required id="email">
                                ...
                                @foreach($subscribers as $subscriber)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="roleButton">
                                                    ...
                                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                           data-bs-target="#editModal{{$subscriber->id}}">Edit</a>
                                                    </li>
                                                    <li>
                                                        <form action="{{route('subscriptions.destroy',$subscriber->id)}}"
                                                              method="POST">
                                                            @method('DELETE')
                                                            @csrf
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="editModal{{$subscriber->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{route('subscriptions.update',$subscriber->id)}}"
                                                                method="POST" id="roleEdit{{$subscriber->id}}" enctype="multipart/form-data">
                                                                @method('PATCH')
                                                                @csrf
                                                                <div class="form-group required">
                                                                    <label class="control-label" for="name">
                                                                ...
                                                                <div class="form-group required">
                                                                    <label class="control-label" for="email">
                                                                        Email:</label>
                                                                    <input type="email" class="form-control complete" name="email"
                                                                           required id="email" value="{{$subscriber->email}}">
                                                                    @error('email') <span class="error">{{ $message }}</span> @enderror
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-primary"
                                                                    form="roleEdit{{$subscriber->id}}">Save changes
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
